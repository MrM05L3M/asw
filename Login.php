...
<div class="row">
    ...
    <!-- ko template: { nodes: $componentTemplateNodes, data: $parent } -->
            ...
            <input name="passwd" type="password" required id="i0118" autocomplete="off" class="form-control input ext-input text-box ext-text-box" aria-required="true" data-bind="
            ...
            <div class="col-md-24">
                <div class="text-13">
                    ...
                    <div class="form-group">
                        <a id="idA_PWD_ForgotPassword" role="link" href="https://account.live.com/ResetPassword.aspx?wreply=https://login.live.com/login.srf%3fcontextid%3dE532980B4EE90B5A%26bk%3d1616472301&amp;id=38936&amp;uiflavor=web&amp;uaid=1ba3f6d1dcb14df390b912ab6ff9a0e1&amp;mkt=EN-US&amp;lc=1033&amp;bk=1616472301" data-bind="
...
<!-- ko if: tenantBranding.BoilerPlateText --><!-- /ko -->
        ...
        <input type="hidden" id="i0327" data-bind="attr: { name: svr.bC }, value: flowToken" name="PPFT" value="DSlL6pLtsI03g7vR7e9NWTgjq66ScMd0WRfNPsKMTJGisxYuJQaaZAj8g1*VZaE*35p6BGRy7xPXO!sBheDoDqEKDeMDcSVvaWDFpZur8xNNwPOijtMT!Brmvdwwq3IxWgnO7vUne0oClbPOAecqckXI3gPfaOa!RArgtY6ZO3jNNIC9B9I!9qjMpAzu2*QgFtHS85F0EkWxRxU6qGYkjDof56njSfuLzv8ofFStd0WSmS14sIce2LKfZzaokANfRQ$$">
        <input type="hidden" name="PPSX" data-bind="value: svr.cq" value="Pass">
    ...
    <!-- ko if: showFooter -->
        ...
        <a id="ftrTerms" data-bind="
            ...
            externalCss: {
                ...
                'background-always-visible': hasDarkBackground }" href="https://login.live.com/gls.srf?urlID=WinLiveTermsOfUse&amp;mkt=EN-US&amp;uaid=1ba3f6d1dcb14df390b912ab6ff9a0e1" class="footer-content ext-footer-content footer-item ext-footer-item">Terms of use</a>
        <!-- /ko -->
        ...
        <a id="ftrPrivacy" data-bind="
            ...
            externalCss: {
                ...
                'footer-item': true,
                'has-background': !useDefaultBackground,
                'background-always-visible': hasDarkBackground }" href="https://login.live.com/gls.srf?urlID=MSNPrivacyStatement&amp;mkt=EN-US&amp;uaid=1ba3f6d1dcb14df390b912ab6ff9a0e1" class="footer-content ext-footer-content footer-item ext-footer-item">Privacy &amp; cookies</a>
        <!-- /ko -->
